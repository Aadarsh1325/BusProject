                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" The Royal Cruiser, The Royal Cruiser, The Royal Cruiser"></span></h1>

                            <!-- <h1 class="main-heading-title"><span class="main-element themecolor"
                                    data-elements=" Reservation System, Reservation System, Reservation System"></span>
                            </h1> -->

                            <p class="main-heading-text">WELCOME TO,<br />E - BUS TICKETING</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">The ROYAL CRUISER</h1>

                            <p class="main-heading-text">The The ROYAL CRUISER is 112 years old and it runs a
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center black">
                        ...
                        <p class="a-slog">Developed By Aadarsh Sharma  
                ...
                <div class="row about-box">
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <div class="margin-bottom">
                            ...
                            <p class="black">Book Bus tickets from anywhere using the rotraint ticketing platform
        ...
        <footer class="site-footer section-spacing text-center " id="eight">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"> <small>&copy; <?php echo date('Y'); ?>, Developed By Aadarsh Sharma </small></div>
